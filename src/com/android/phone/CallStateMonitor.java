...
class CallStateMonitor extends Handler {
    ...
    public static final int PHONE_CALL_VIDEO_MODE_CHANGED = 14;
    ...
    private void registerForNotifications() {
        ...
        callManager.registerForCallVideoModeUpdate(this, PHONE_CALL_VIDEO_MODE_CHANGED, null);
    }
    ...
    public void updateAfterRadioTechnologyChange() {
        ...
        callManager.unregisterForCallVideoModeUpdate(this);
